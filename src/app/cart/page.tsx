                          ...
                          if (isNaN(newQuantity) || newQuantity < 1) {
                            dispatch(
                              updateQuantity({
                                productId: +item.productId,
                                variantId: +item.variantId,
                                newQuantity: 1, // Revert to minimum quantity
                              })
                            );
                          }
                        }}
                        min="1"
                        className="w-12 h-8 border border-gray-300 rounded-md text-center text-sm bg-white focus:outline-none focus:ring-2 focus:ring-rose-500"
                      />
                      <motion.button
                        whileHover={{ scale: 1.1 }}
                        whileTap={{ scale: 0.9 }}
