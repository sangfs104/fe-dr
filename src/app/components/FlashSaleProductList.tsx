...
export default function FlashSaleProductList() {
  ...
  return (
    <div className="space-y-20 px-6 sm:px-10 md:px-20 lg:px-40 pt-12">
      {flashSales.map((sale) => (
...
//             }}
//             style={{ paddingBottom: 4, paddingLeft: 12 }} //
//           >
//             {sale.variants.map((variant) => {
//               const percentSold =
//                 (variant.flash_sold / variant.flash_quantity) * 100;
...
//               return (
//                 <SwiperSlide key={variant.id} className="!w-[270px]">
//                   <div className="fire-card group relative bg-white rounded-2xl p-4 shadow hover:shadow-lg transition duration-300 h-full flex flex-col">
//                     <ProductCard
//                       product={{
//                         id: variant.product_id,
//                         name: variant.name,
