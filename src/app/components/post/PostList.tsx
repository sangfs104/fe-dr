...
interface Post {
  ...
  images?: { url: string }[]; // Thêm để hỗ trợ mảng images cho sản phẩm hoặc bài viết
}
            ...
            {showProduct && (
              ...
              >
                <ProductCard
                  product={{
                    ...post.product,
                    image_url: post.images?.[0]?.url || post.image_url || "", // Sử dụng images nếu có, fallback về image_url
                  }}
                />
              </motion.div>
            )}
