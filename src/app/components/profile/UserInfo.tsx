...
//   role: string;
//   day_of_birth?: string | null;
//   avatar_url?: string | null; // Prioritize avatar_url for display
//   is_active?: string;
//   created_at?: string;
//   updated_at?: string;
//   google_id?: string;
...
//       // Ensure avatar_url is updated in localStorage
//       const updatedUser = {
//         ...res.data.data,
...
export default function UserInfo() {
  ...
  // Load user data from localStorage and fetch latest from API
  useEffect(() => {
