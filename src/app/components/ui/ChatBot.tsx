...
export default function ChatBox({ onClose }: { onClose: () => void }) {
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      const { message, style_name, products } = res.data;

      let reply = message || (style_name
      ...
      let errorMessage = "❌ Không thể kết nối đến hệ thống. Vui lòng thử lại.";
      if (error.response) {
                ...
                <div className="relative">
                  <Image
                    ...
                    onError={(e) => {
                      ...
                      e.currentTarget.src = "/img/fallback-avatar.png";
                    }}
                  />
                </div>
              )}
