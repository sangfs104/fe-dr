            ...
            {items.map((item, index) => (
              <motion.li key={index} variants={itemVariants} className="group">
                <button
                  ...
                  className="w-full text-left flex items-center justify-between px-5 py-3 text-sm text-gray-800 hover:bg-purple-50 hover:text-purple-700 transition duration-300"
                >
                  {item.label[language]}
