...
//   return (
//     <footer className="bg-white text-gray-800 px-40 py-12 border-t border-gray-200">
...
export default function Footer() {
  return (
    <footer className="bg-white text-gray-800 px-4 sm:px-6 md:px-10 lg:px-20 xl:px-40 py-12 border-t border-gray-200">
        ...
        <div>
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center space-y-2 sm:space-y-0 sm:space-x-2">
            <input
              ...
              className="flex-1 border border-gray-300 px-3 py-2 rounded-md text-sm"
            />
            <button className="bg-black text-white px-4 py-2 rounded-md text-sm hover:bg-gray-800 whitespace-nowrap">
              Đăng ký
            </button>
          </div>
          <div className="flex items-center gap-3 mt-6">
