...
//         apiUrl = "http://localhost:8000/api/payment/cod";
//       } else {
//         apiUrl = "http://localhost:8000/api/payment/vnpay";
//       }
...
//         // Điều hướng tới trang xác nhận đơn hàng hoặc hiển thị thông báo thành công
//         alert("Đặt hàng thành công! Bạn sẽ thanh toán khi nhận hàng.");
//         // window.location.href = "/order-success"; // nếu bạn có trang xác nhận
//       }
//     } catch (err) {
  ...
  const handlePayment = async () => {
    ...
    try {
      ...
      if (paymentMethod === "bank" && response.data.payment_url) {
        ...
        // Có thể chuyển hướng đến trang thành công nếu muốn
                ...
                onClick={async (e) => {
                  ...
                  try {
                    const response = await axios.post(
                      "http://localhost:8000/api/discount/apply",
                      {
                        code: couponCode,
                        total,
                      }
                    ...
                    if (response.data.valid) {
                      setDiscount(response.data.discountAmount); // đơn vị: VND
